package com.wjc.myrecyclerlayout.layout;
 ...
 */
public class JCPullRecyclerLayout extends LinearLayout implements NestedScrollingParent {
    ...
    public JCPullRecyclerLayout(Context context) {
        super(context);
        this.context = context;
        inital();
    }

    public JCPullRecyclerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        inital();
    }
    ...
    public void setMyRecyclerView(RecyclerView.LayoutManager layoutManager, JCRecyclerAdapter adapter) {
        myRecyclerView.setMyLayoutManager(layoutManager);
        myRecyclerView.setAdapter(adapter);
    }

    public void setMyRecyclerView(RecyclerView.LayoutManager layoutManager, JCRecyclerAdapter adapter, boolean fixed) {
        myRecyclerView.setMyLayoutManager(layoutManager);
        myRecyclerView.setAdapter(adapter);
